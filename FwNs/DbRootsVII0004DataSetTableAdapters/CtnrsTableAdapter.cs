namespace FwNs.DbRootsVII0004DataSetTableAdapters
{
    ...
    public class CtnrsTableAdapter : Component
    {
        ...
        public virtual int Delete(int Original_Id, int? Original_IdD, int? Original_IdC, int? Original_IdW, DateTime? Original_Cr8D8, DateTime? Original_ChkD8)
        {
            int num;
            this.Adapter.DeleteCommand.Parameters[0].Value = Original_Id;
            if (Original_IdD.HasValue)
            {
                this.Adapter.DeleteCommand.Parameters[1].Value = 0;
                this.Adapter.DeleteCommand.Parameters[2].Value = Original_IdD.Value;
            }
            else
            {
            ...
            if (Original_IdC.HasValue)
            {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = Original_IdC.Value;
            }
            else
            {
            ...
            if (Original_IdW.HasValue)
            {
                ...
                this.Adapter.DeleteCommand.Parameters[6].Value = Original_IdW.Value;
            }
            else
            {
        ...
        public virtual int Fill(DbRootsVII0004DataSet.CtnrsDataTable dataTable)
        {
        ...
        public virtual DbRootsVII0004DataSet.CtnrsDataTable GetData()
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DbRootsVII0004DataSet.CtnrsDataTable dataTable = new DbRootsVII0004DataSet.CtnrsDataTable();
        ...
        private void InitAdapter()
        {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Ctnrs] WHERE (([Id] = @Original_Id) AND ((@IsNull_IdD = 1 AND [IdD] IS NULL) OR ([IdD] = @Original_IdD)) AND ((@IsNull_IdC = 1 AND [IdC] IS NULL) OR ([IdC] = @Original_IdC)) AND ((@IsNull_IdW = 1 AND [IdW] IS NULL) OR ([IdW] = @Original_IdW)) AND ((@IsNull_Cr8D8 = 1 AND [Cr8D8] IS NULL) OR ([Cr8D8] = @Original_Cr8D8)) AND ((@IsNull_ChkD8 = 1 AND [ChkD8] IS NULL) OR ([ChkD8] = @Original_ChkD8)))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@IsNull_IdD", SqlDbType.Int, 0, ParameterDirection.Input, 0, 0, "IdD", DataRowVersion.Original, true, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@Original_IdD", SqlDbType.Int, 0, ParameterDirection.Input, 0, 0, "IdD", DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Ctnrs] ([Id], [IdD], [IdC], [IdW], [Cr8D8], [ChkD8], [Nfo]) VALUES (@Id, @IdD, @IdC, @IdW, @Cr8D8, @ChkD8, @Nfo);\r\nSELECT Id, IdD, IdC, IdW, Cr8D8, ChkD8, Nfo FROM Ctnrs WHERE (Id = @Id)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@IdD", SqlDbType.Int, 0, ParameterDirection.Input, 0, 0, "IdD", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Ctnrs] SET [Id] = @Id, [IdD] = @IdD, [IdC] = @IdC, [IdW] = @IdW, [Cr8D8] = @Cr8D8, [ChkD8] = @ChkD8, [Nfo] = @Nfo WHERE (([Id] = @Original_Id) AND ((@IsNull_IdD = 1 AND [IdD] IS NULL) OR ([IdD] = @Original_IdD)) AND ((@IsNull_IdC = 1 AND [IdC] IS NULL) OR ([IdC] = @Original_IdC)) AND ((@IsNull_IdW = 1 AND [IdW] IS NULL) OR ([IdW] = @Original_IdW)) AND ((@IsNull_Cr8D8 = 1 AND [Cr8D8] IS NULL) OR ([Cr8D8] = @Original_Cr8D8)) AND ((@IsNull_ChkD8 = 1 AND [ChkD8] IS NULL) OR ([ChkD8] = @Original_ChkD8)));\r\nSELECT Id, IdD, IdC, IdW, Cr8D8, ChkD8, Nfo FROM Ctnrs WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@IdD", SqlDbType.Int, 0, ParameterDirection.Input, 0, 0, "IdD", DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@IsNull_IdD", SqlDbType.Int, 0, ParameterDirection.Input, 0, 0, "IdD", DataRowVersion.Original, true, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@Original_IdD", SqlDbType.Int, 0, ParameterDirection.Input, 0, 0, "IdD", DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, IdD, IdC, IdW, Cr8D8, ChkD8, Nfo FROM dbo.Ctnrs";
        ...
        public virtual int Insert(int Id, int? IdD, int? IdC, int? IdW, DateTime? Cr8D8, DateTime? ChkD8, string Nfo)
        {
            int num;
            this.Adapter.InsertCommand.Parameters[0].Value = Id;
            if (IdD.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[1].Value = IdD.Value;
            }
            else
            {
            ...
            if (IdC.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[2].Value = IdC.Value;
            }
            else
            {
            ...
            if (IdW.HasValue)
            {
                this.Adapter.InsertCommand.Parameters[3].Value = IdW.Value;
            }
            else
            {
        ...
        {
            return this.Adapter.Update(dataSet, "Ctnrs");
        }

        [DebuggerNonUserCode, GeneratedCode("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"), HelpKeyword("vs.data.TableAdapter")]
        public virtual int Update(DbRootsVII0004DataSet.CtnrsDataTable dataTable)
        {
        ...
        public virtual int Update(int? IdD, int? IdC, int? IdW, DateTime? Cr8D8, DateTime? ChkD8, string Nfo, int Original_Id, int? Original_IdD, int? Original_IdC, int? Original_IdW, DateTime? Original_Cr8D8, DateTime? Original_ChkD8)
        {
            return this.Update(Original_Id, IdD, IdC, IdW, Cr8D8, ChkD8, Nfo, Original_Id, Original_IdD, Original_IdC, Original_IdW, Original_Cr8D8, Original_ChkD8);
        }

        [DebuggerNonUserCode, GeneratedCode("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"), HelpKeyword("vs.data.TableAdapter"), DataObjectMethod(DataObjectMethodType.Update, true)]
        public virtual int Update(int Id, int? IdD, int? IdC, int? IdW, DateTime? Cr8D8, DateTime? ChkD8, string Nfo, int Original_Id, int? Original_IdD, int? Original_IdC, int? Original_IdW, DateTime? Original_Cr8D8, DateTime? Original_ChkD8)
        {
            int num;
            this.Adapter.UpdateCommand.Parameters[0].Value = Id;
            if (IdD.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[1].Value = IdD.Value;
            }
            else
            {
            ...
            if (IdC.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[2].Value = IdC.Value;
            }
            else
            {
            ...
            if (IdW.HasValue)
            {
                this.Adapter.UpdateCommand.Parameters[3].Value = IdW.Value;
            }
            else
            {
            ...
            if (Original_IdD.HasValue)
            {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = Original_IdD.Value;
            }
            else
            {
            ...
            if (Original_IdC.HasValue)
            {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = Original_IdC.Value;
            }
            else
            {
            ...
            if (Original_IdW.HasValue)
            {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = Original_IdW.Value;
            }
            else
            {
