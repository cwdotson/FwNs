namespace FwNs.DbRootsVII0004DataSetTableAdapters
{
    ...
    public class MchnsTableAdapter : Component
    {
        ...
        public virtual int Fill(DbRootsVII0004DataSet.MchnsDataTable dataTable)
        {
        ...
        public virtual DbRootsVII0004DataSet.MchnsDataTable GetData()
        {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DbRootsVII0004DataSet.MchnsDataTable dataTable = new DbRootsVII0004DataSet.MchnsDataTable();
        ...
        private void InitAdapter()
        {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Mchns] WHERE (([Id] = @Original_Id) AND ((@IsNull_IdR = 1 AND [IdR] IS NULL) OR ([IdR] = @Original_IdR)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Mchns] ([Id], [IdR], [Nm]) VALUES (@Id, @IdR, @Nm);\r\nSELECT Id, IdR, Nm FROM Mchns WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Mchns] SET [Id] = @Id, [IdR] = @IdR, [Nm] = @Nm WHERE (([Id] = @Original_Id) AND ((@IsNull_IdR = 1 AND [IdR] IS NULL) OR ([IdR] = @Original_IdR)));\r\nSELECT Id, IdR, Nm FROM Mchns WHERE (Id = @Id)";
        ...
        private void InitCommandCollection()
        {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, IdR, Nm FROM dbo.Mchns";
        ...
        public virtual int Insert(int Id, int? IdR, string Nm)
        {
            int num;
        ...
        {
            return this.Adapter.Update(dataSet, "Mchns");
        }

        [DebuggerNonUserCode, GeneratedCode("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"), HelpKeyword("vs.data.TableAdapter")]
        public virtual int Update(DbRootsVII0004DataSet.MchnsDataTable dataTable)
        {
        ...
        public virtual int Update(int? IdR, string Nm, int Original_Id, int? Original_IdR)
        {
            return this.Update(Original_Id, IdR, Nm, Original_Id, Original_IdR);
        }

        [DebuggerNonUserCode, GeneratedCode("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"), HelpKeyword("vs.data.TableAdapter"), DataObjectMethod(DataObjectMethodType.Update, true)]
        public virtual int Update(int Id, int? IdR, string Nm, int Original_Id, int? Original_IdR)
        {
            int num;
